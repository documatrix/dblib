...
namespace Mysql {
	...
	public class Database {
		...
		[CCode (cname = "mysql_stmt_init")]
		public Statment create_statment ();
	}

	[Compact]
	[CCode (free_function = "mysql_stmt_close", cname = "MYSQL_STMT", cprefix = "mysql_stmt_")]
	public class Statment {
		public int prepare (string query, ulong length);
		public int bind_param (Bind* binds);
		public int bind_result (Bind* binds);
		public int execute ();
